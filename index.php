  ...
  <footer id="footer" class="p-3 bg-dark">
    ...
    <div class="row p-3">
      <div class="col mt-3">
        ...
        <p class="text-secondary fs-6">Banda Aceh,Darussalam,Universitas Syiah Kuala  </p>telpone +62 822809 8090<p
        <h3 class="text-light fs-5">Telepone</h3>
        <p class="text-secondary fs-6"> +62 822809 8090  </p>
          </div>
          </div>
        ...
        <div class="d-flex justify-content-center align-items-center mt-3">
          <p class="text-light">PROJECT SISTEM INFORMASI</a> 2024</p>
        </div>
      </div>
  </footer>
